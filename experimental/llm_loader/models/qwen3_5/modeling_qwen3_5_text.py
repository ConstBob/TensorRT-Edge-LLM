...
"""
Qwen3.5 LLM backbone.

The Qwen3.5 text decoder is a standard Qwen3 transformer. The default
...
"""
from ..default.modeling_default import CausalLM as Qwen3_5LanguageModel

__all__ = ["Qwen3_5LanguageModel"]
