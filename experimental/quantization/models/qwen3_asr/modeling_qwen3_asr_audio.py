...
:mod:`experimental.llm_loader.models.qwen3_asr.modeling_qwen3_asr_audio`,
...
design contract — :mod:`experimental.quantization` must not import from
:mod:`experimental.llm_loader`.
"""
