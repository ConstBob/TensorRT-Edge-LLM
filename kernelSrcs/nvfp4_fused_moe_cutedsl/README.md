...
- `nvidia-cutlass-dsl == 4.6.1` (CUDA 13: `[cu13]` extra; CUDA 12: base package)
...
pip install 'nvidia-cutlass-dsl[cu13]==4.6.1'  # CUDA 13.x
# CUDA 12.x: pip install 'nvidia-cutlass-dsl==4.6.1'
```
