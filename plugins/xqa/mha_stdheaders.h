...
template <typename T> DEVICE_FUNC constexpr T const& max(T const& a, T const& b) {
    return a > b ? a : b;
}

template <typename T> DEVICE_FUNC constexpr T const& min(T const& a, T const& b) {
    return a < b ? a : b;
}
...
namespace libstdcpp
{
  ...
  template<size_t _Idx, typename _Head>
    ...
    : public _Head
    {
      ...
      DEVICE_FUNC _Head_base(const _Head& __h)
      : _Head(__h) { }
    ...
    : _Head(forward<_UHead>(__h)) { }
      ...
      DEVICE_FUNC const _Head& _M_head() const { return *this; }
  ...
  template<size_t _Idx, typename _Head>
    ...
    : _M_head_impl(forward<_UHead>(__h)) { }
      ...
      DEVICE_FUNC const _Head& _M_head() const { return _M_head_impl; }
  ...
  template<size_t _Idx, typename _Head, typename... _Tail>
      ...
      private _Head_base<_Idx, _Head, is_empty<_Head>::value>
    {
      ...
      DEVICE_FUNC const _Head&      _M_head() const { return _Base::_M_head(); }

      DEVICE_FUNC _Inherited&       _M_tail()       { return *this; }
      DEVICE_FUNC const _Inherited& _M_tail() const { return *this; }

      DEVICE_FUNC _Tuple_impl()
      : _Inherited(), _Base() { }

      explicit
      DEVICE_FUNC _Tuple_impl(const _Head& __head, const _Tail&... __tail)
      : _Inherited(__tail...), _Base(__head) { }

      template<typename _UHead, typename... _UTail>
        explicit
        DEVICE_FUNC _Tuple_impl(_UHead&& __head, _UTail&&... __tail)
    : _Inherited(forward<_UTail>(__tail)...),
      _Base(forward<_UHead>(__head)) { }

      DEVICE_FUNC _Tuple_impl(const _Tuple_impl& __in)
    ...
    _Base(forward<_Head>(__in._M_head())) { }
      ...
      template<typename... _UElements>
        DEVICE_FUNC _Tuple_impl(const _Tuple_impl<_Idx, _UElements...>& __in)
    : _Inherited(__in._M_tail()), _Base(__in._M_head()) { }
  ...
  template<typename... _Elements>
    ...
    public:
      ...
      explicit
      DEVICE_FUNC tuple(const _Elements&... __elements)
      : _Inherited(__elements...) { }

      template<typename... _UElements>
        explicit
        DEVICE_FUNC tuple(_UElements&&... __elements)
    : _Inherited(forward<_UElements>(__elements)...) { }

      DEVICE_FUNC tuple(const tuple& __in)
      ...
      template<typename... _UElements>
        DEVICE_FUNC tuple(const tuple<_UElements...>& __in)
  ...
  template<size_t __i, typename _Head, typename... _Tail>
    DEVICE_FUNC inline typename __add_ref<_Head>::type
    __get_helper(_Tuple_impl<__i, _Head, _Tail...>& __t)
    { return __t._M_head(); }

  template<size_t __i, typename _Head, typename... _Tail>
    DEVICE_FUNC inline typename __add_c_ref<_Head>::type
  ...
  template<size_t __i, typename... _Elements>
    DEVICE_FUNC inline typename __add_ref<
  ...
  template<size_t __i, typename... _Elements>
    DEVICE_FUNC inline typename __add_c_ref<
                      typename tuple_element<__i, tuple<_Elements...> >::type
                    >::type
  ...
  template<size_t __check_equal_size, size_t __i, size_t __j,
  ...
  template<size_t __i, size_t __j, typename _Tp, typename _Up>
    ...
    {
      DEVICE_FUNC static bool __eq(const _Tp& __t, const _Up& __u)
      {
    return (get<__i>(__t) == get<__i>(__u) &&
        __tuple_compare<0, __i + 1, __j, _Tp, _Up>::__eq(__t, __u));
      }

      DEVICE_FUNC static bool __less(const _Tp& __t, const _Up& __u)
      {
    return ((get<__i>(__t) < get<__i>(__u))
  ...
  template<size_t...> struct __index_holder { };

  template<size_t __i, typename _IdxHolder, typename... _Elements>
    struct __index_holder_impl;

  template<size_t __i, size_t... _Indexes, typename _IdxHolder,
       typename... _Elements>
  ...
  template<typename... _TElements, size_t... _TIdx,
       typename... _UElements, size_t... _UIdx>
    DEVICE_FUNC inline tuple<_TElements..., _UElements...>
  ...
  template<typename... _TElements, size_t... _TIdx,
    ...
    (move(get<_TIdx>(__t))..., get<_UIdx>(__u)...); }
  ...
  template<typename... _TElements, size_t... _TIdx,
    ...
    __tuple_cat_helper(const tuple<_TElements...>& __t,
               ...
               const __index_holder<_UIdx...>&)
    { return tuple<_TElements..., _UElements...>
    (get<_TIdx>(__t)..., move(get<_UIdx>(__u))...); }
  ...
  template<typename... _TElements, size_t... _TIdx,
    ...
    __tuple_cat_helper(tuple<_TElements...>&& __t,
               ...
               const __index_holder<_UIdx...>&)
    { return tuple<_TElements..., _UElements...>
    (move(get<_TIdx>(__t))..., move(get<_UIdx>(__u))...); }
  ...
  template<typename... _TElements, typename... _UElements>
    ...
    {
      return __tuple_cat_helper(move(__t), typename
                 __make_index_holder<_TElements...>::type(),
                 __u, typename
                 __make_index_holder<_UElements...>::type());
    }
  ...
  template<typename... _Elements>
    DEVICE_FUNC inline tuple<_Elements&...>
...
namespace detail
{
    ...
    auto try_add_pointer(int)
      -> type_identity<typename remove_reference<T>::type*>;  // usual case
...
#else
template <typename T> using is_void = is_same<remove_cv_t<T>, void>;
