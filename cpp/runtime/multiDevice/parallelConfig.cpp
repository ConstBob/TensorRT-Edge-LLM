...
std::string ParallelConfig::toString() const
{
    ...
    ss << ", enableShmAllReduce=" << (shmAllReduceConfig.enableShmAllReduce ? "true" : "false")
       << ", shmMaxElements=" << shmAllReduceConfig.shmMaxElements
       << ", shmAllReduceElementThreshold=" << shmAllReduceConfig.shmAllReduceElementThreshold
       << ", shmFp8SmallPathElementThreshold=" << shmAllReduceConfig.shmFp8SmallPathElementThreshold;
