...
//   * D   : [M, N] Float16 row-major   (run() — used by the FP16 SHM
//                                       AllReduce + NCCL fallback paths)
//   * D   : [M, N] Float8E4M3FN        (runFp8() — used by the single-CTA
//                                       FP8 SHM AllReduce decode path)
