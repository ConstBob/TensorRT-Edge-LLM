...
private:
    ...
    std::tuple<int64_t, int64_t> getResizedImageSize(int64_t const height, int64_t const width);
    ...
    std::vector<std::pair<int64_t, int64_t>> getAllSupportedAspectRatios(
        int64_t const minImageTiles = 1, int64_t const maxImageTiles = 12);
