    ...
    int64_t const& hiddenSizePerHead, int64_t const& imageHiddenSize, int64_t const& mropeDim)
{
    ...
    std::string trtExecCommand = fmtstr(
        ...
        "--verbose "
        "--profile 0 "
        "--minShape=input_ids:%ldx%ld,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx0x%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1 "
        "--optShape=input_ids:%ldx%ld,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx0x%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1 "
        "--maxShape=input_ids:%ldx%ld,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx0x%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1 "
        "--profile 1 "
        "--minShape=input_ids:%ldx1,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx%ldx%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1 "
        "--optShape=input_ids:%ldx1,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx%ldx%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1 "
        "--maxShape=input_ids:%ldx1,context_lengths:%ld,last_token_ids:%ld*1,past_key_values.*:%ldx2x%ldx%ldx%ld,image_"
        "embeds:%ldx%ld,mrope_rotary_cos_sin:%ldx%ld,mrope_position_deltas:%ldx1",
