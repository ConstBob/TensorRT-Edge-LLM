...
- ~~`tensorrt-edgellm-quantize` exposes FP8 visual-tower quantization for supported VLM checkpoints. Other visual-tower precisions are not exposed in this release.~~ Fixed in 0.7.1.
- ~~Qwen3-TTS is supported end-to-end through a hybrid export workflow.~~ Fixed in 0.7.1.
