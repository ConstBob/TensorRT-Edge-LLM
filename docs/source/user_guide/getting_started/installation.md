...
| `ENABLE_CUTE_DSL` | Enable AOT-compiled CuTe DSL kernels (build with `kernelSrcs/build_cutedsl.py`): `OFF` (default), `ALL`, or a group list such as `gdn`, `fmha`, `gemm`, or `ssd` | OFF |
