...
**⚠️ USER RESPONSIBILITY**: Users are responsible for verifying model integrity before export and build, validating outputs, and maintaining proper model sanity throughout the pipeline. See [Security and Model Integrity](03.1_Python_Export_Pipeline.md#security-and-model-integrity) for verification best practices.
...
**Qwen2/2.5-VL Models** (`setupQwenViTProfile`):
