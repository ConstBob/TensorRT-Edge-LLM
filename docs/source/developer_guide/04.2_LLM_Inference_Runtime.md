...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    ENGINE_RUNNER[LLM Engine<br>Runner]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
...
1. **Learn About Speculative Decoding**: See [LLM Inference SpecDecode Runtime](04.3_LLM_Inference_SpecDecode_Runtime.md) for EAGLE support
2. **Explore Advanced Features**: See [Advanced Runtime Features](04.4_Advanced_Runtime_Features.md) for CUDA graphs, LoRA, and more
