...
**Previous**: [LLM Inference SpecDecode Runtime](04.3_LLM_Inference_SpecDecode_Runtime.md) | **Next**: [Examples](05_Examples.md)
...
- **SpecDecode Limitation**: EAGLE mode is limited to batch size 1
...
4. **Review API Documentation**: See detailed API docs in `cpp/runtime/` headers
...
- **LoRA Support**: See LoRA documentation in Python Export Pipeline
