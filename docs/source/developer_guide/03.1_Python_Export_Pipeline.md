...
- **FP8 Vision Encoder**: Supported for visual models, such as Qwen2-VL and InternVL3
...
**Solution**: Use `--device cpu` flag or reduce calibration dataset size. However, CPU support may fail for some precisions.
...
- **Quantization Details**: Refer to NVIDIA ModelOpt documentation
