...
2. **Int4GroupwiseGemmPlugin**: Int4 weights-only groupwise GEMM and GEMV using the AWQ CUDA-C++ kernels (swizzled weights).
...
- `1`: `Int4GroupwiseGemmPlugin` (AWQ swizzled weights) — legacy fallback.
