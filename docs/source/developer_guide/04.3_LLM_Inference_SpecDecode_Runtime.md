...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    ENGINE_RUNNER[LLM Engine<br>Runner Base]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class ENGINE_RUNNER nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    MULTIMODAL[Multimodal<br>Runner]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class MULTIMODAL nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    KV_CACHE[Linear<br>KV Cache]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class KV_CACHE nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    SAMPLER[Sampling<br>Kernels]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class SAMPLER nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    EAGLE_KERNELS[EAGLE Util<br>Kernels]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class EAGLE_KERNELS nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    TRT_ENGINE[TRT Engines<br>Dual]
    classDef greyNode fill:#f4f4f4, stroke-width:0px
    class TRT_ENGINE greyNode
```
...
1. **Explore Advanced Features**: See [Advanced Runtime Features](04.4_Advanced_Runtime_Features.md) for CUDA graphs, LoRA, and more
...
- **EAGLE Documentation**: See EAGLE-specific documentation in `cpp/runtime/eagleDraftEngineRunner.h`
- **Architecture Overview**: See [Overview](01.1_Overview.md)
