...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    LLM_BUILDER[LLM Builder]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class LLM_BUILDER nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    VISUAL_BUILDER[Visual Encoder Builder]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class VISUAL_BUILDER nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    LLM_BUILDER[#160; LLM Builder #160;]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class LLM_BUILDER nvNode
```
...
%%{init: {'themeVariables': {'edgeLabelBackground': 'white'}}}%%
graph LR
    VISUAL_BUILDER[#160; Visual Encoder Builder #160;]
    classDef nvNode fill:#76B900, stroke-width:0px, color:#ffffff
    class VISUAL_BUILDER nvNode
```
